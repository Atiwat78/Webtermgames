...
// --- 🎨 [ปรับปรุง] เปลี่ยนเป็นข้อมูล Free Fire ---
$current_game_data = [
    'id' => 'freefire',
    'name' => 'Free Fire',
    'image' => 'image/free-fire-seeklogo.png', // (ใช้โลโก้จากหน้า topup.php)
    'description' => 'บริการเติมเพชร (Diamonds) นี้สำหรับผู้เล่น Garena Free Fire ในประเทศไทยเท่านั้น'
];

// --- 🎨 [ปรับปรุง] เปลี่ยนเป็นเรทราคาของ Free Fire (เพชร) ---
$current_price_list = [
...
<head>
    ...
    <title>💎 เติมเงิน Free Fire - ntyztermgame</title>
    <link href="https://fonts.googleapis.com/css2?family=Sarabun:wght@400;500;600;700&display=swap" rel="stylesheet" />
    
<style>
    /* --- 🎨 ธีมหลัก (Light Mode: ขาว-ทอง) --- */
    body {
                ...
                <?php foreach ($current_price_list as $package) : ?>
                    <div class="price-card" 
                        ...
                        <div class="package-info">
                            <img src="image/freefire-diamond.png" alt="เพชร" class="coupon-icon">
...
<script>
    ...
    // --- Logic ปุ่มยืนทนยันการสั่งซื้อ (เหมือนเดิม) ---
