<?php
session_start();
require_once 'db.php'; // เรียกใช้ DB (มาตรฐานใหม่ของเรา)
...
$current_game_data = [
    ...
    'description' => 'บริการเติมเพชร (Diamonds) นี้สำหรับผู้เล่น Garena Free Fire ในประเทศไทยเท่านั้น'
];

// --- เรทราคา Free Fire ---
$current_price_list = [
    ['amount' => '25 เพชร', 'price' => 19, 'tag' => null],
    ['amount' => '50 เพชร', 'price' => 35, 'tag' => null],
    ['amount' => '110 เพชร', 'price' => 69, 'tag' => null],
    ['amount' => '230 เพชร', 'price' => 139, 'tag' => null],
    ['amount' => '580 เพชร', 'price' => 349, 'tag' => null],
    ['amount' => '1,180 เพชร', 'price' => 699, 'tag' => 'ยอดนิยม'],
    ['amount' => '2,400 เพชร', 'price' => 1390, 'tag' => 'สุดคุ้ม'],
    ['amount' => '6,100 เพชร', 'price' => 3490, 'tag' => 'สุดคุ้ม'],
];
?>
<!DOCTYPE html>
<html lang="th">
<head>
    ...
    <title>💎 เติมเงิน Free Fire - Elite Topup</title>
    <link href="https://fonts.googleapis.com/css2?family=Sarabun:wght@400;500;600;700&display=swap" rel="stylesheet" />
    
<style>
    /* --- CSS เฉพาะของหน้าเติมเงิน (Navbar CSS ย้ายไปอยู่ navbar.php แล้ว) --- */
    body {
    ...
    /* Sidebar Form */
    .sidebar-box { background: #ffffff; border: 1px solid #e5e7eb; border-radius: 12px; padding: 24px; margin-bottom: 20px; }
    ...
    .btn { padding: 14px; border: none; border-radius: 8px; cursor: pointer; font-weight: 700; font-size: 16px; font-family: 'Sarabun', sans-serif; transition: all 0.3s ease; }
    .btn:hover { opacity: 0.9; transform: translateY(-2px); }
    .btn.btn-primary { background-color: #DAA520; color: #fff; box-shadow: 0 5px 15px rgba(218, 165, 32, 0.3); }
    .btn.btn-primary:hover { box-shadow: 0 8px 20px rgba(218, 165, 32, 0.4); }
                ...
                <?php foreach ($current_price_list as $package) : ?>
                    <div class="price-card" 
                        ...
                        <div class="package-info">
                            <img src="image/diamon.png" alt="เพชร" class="coupon-icon" onerror="this.src='image/copong.png'">
        ...
        <div class="order-sidebar">
            <div class="sidebar-box">
                ...
                <div class="input-group">
                    ...
                    <input type="text" id="player-id" placeholder="กรุณากรอก Player ID ของคุณ">
...
<script>
    ...
    buyButton.addEventListener('click', function() {
        ...
        if (playerId === "") {
            alert('กรุณากรอก Player ID ของคุณ');
            playerIdInput.focus();
            return;
        }
        if (!selectedPackage) {
    ...
    // --- Theme Toggle Logic (สำหรับ Navbar ที่ Include มา) ---
    ...
    // ติ๊กถูกปุ่มถ้าเป็น Dark Mode (เช็คว่าปุ่มโหลดมาหรือยัง)
